...
<script type="text/javascript">
	function addCart(pid) {
		var byNum=$("#byNum").val();
		window.location.href="${pageContext.request.contextPath }/cart/addCart.action?pid="+pid+"&byNum="+byNum;
	}
</script>
</head>
	...
	<div class="container">
		<div class="row">
			...
			<div style="margin: 0 auto; width: 950px;">
				<div class="col-md-6">
					<img style="opacity: 1; width: 300px; height: 250px;" title=""
						class="medium"
					...
					<div class="col-md-6">
						...
						<div
							...
							<div
								...
								购买数量: <input id="byNum" name="byNum" value="1"
									maxlength="4" size="10" type="text">
							</div>

							<div style="margin: 20px 0 10px 0;; text-align: center;">
								<a href="javascript:void(0);"
									onclick="addCart('${product.pid}')"> <input
			...
			<div style="width: 950px; margin: 0 auto;">
				...
				<div align="center">
				<div><span style="color: red;font-size: 25px">${product.pdesc }</span></div>
