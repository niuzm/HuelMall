...
<html>
	...
	<head>
		...
		//确认订单跳转页面
		function firmOrder(oid) {
			//通过jquery得到表单数据
			var address=$("#address").val();
			var name=$("#name").val();
			var telephone=$("#telephone").val();
			window.location.href="${pageContext.request.contextPath }/order/firmOrder.action?oid="+oid+"&address="+address+"&name="+name+"&telephone="+telephone;
		}
		</script>
	</head>
			...
			<div>
				...
				<form class="form-horizontal" style="margin-top:5px;margin-left:150px;">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" value="" id="address" name="address" placeholder="请输入收货地址">
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword3" class="col-sm-1 control-label">收货人</label>
						<div class="col-sm-5">
							<input type="text" value="" class="form-control" id="name" name="name" placeholder="请输收货人">
						</div>
					</div>
					<div class="form-group">
						<label for="confirmpwd" class="col-sm-1 control-label">电话</label>
						<div class="col-sm-5">
							<input type="text"  value="" class="form-control" id="telephone" name="telephone" placeholder="请输入联系方式">
						</div>
					</div>
				</form>
				...
				<div style="margin-top:5px;margin-left:150px;">
					...
					<p style="text-align:right;margin-right:100px;">
						<a href="javascript:void(0);" onclick="firmOrder('${orders.oid}')">
