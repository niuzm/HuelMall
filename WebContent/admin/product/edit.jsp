...
<HTML>
	<HEAD>
		...
		<LINK href="${pageContext.request.contextPath}/css/Style1.css" type="text/css" rel="stylesheet">
			...
			$(function(){
				...
				//是哪一个分类
				$("#category.cid option[value='${cid }']").prop("selected",true);
			});
			</script>
	</HEAD>
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/admin/updateProducta.action" method="post" >
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="category.cid" id="category.cid">
